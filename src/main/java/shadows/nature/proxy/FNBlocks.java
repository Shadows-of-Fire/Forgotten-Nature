...
import ForgottenNature.Blocks.*;
import ForgottenNature.Handlers.BreakBlockHandler;
import ForgottenNature.ForgottenNature;
import ForgottenNature.Items.*;
import ForgottenNature.Items.ItemTorch;
...
public class FNBlocks 
{
	...
	public static Block newTorch = new BlockNewTorch().setStepSound(Block.soundTypeGlass).setLightLevel(1.0F).setBlockName("crystalTorch").setCreativeTab(tab);
	public static Block mushroomCrystal = new BlockCrystalMushroom().setHardness(0.5F).setStepSound(Block.soundTypeGlass).setLightLevel(0.8F).setBlockName("cMushroom").setCreativeTab(tab);
	public static Block mushroomCrystalBlock = new BlockCrystalMushroomBlock().setHardness(2.0F).setStepSound(Block.soundTypeGlass).setLightLevel(0.9F).setBlockName("cMushroomBlock").setCreativeTab(tab);
	...
	public static Block newLeaves1 = new BlockNewLeaves(ForgottenNature.figFruit, newFruit, 7, 0).setCreativeTab(tab).setBlockName("FNLeaves1");
	public static Block newLeaves2 = new BlockNewLeaves(false, null, 7, 1).setCreativeTab(tab).setBlockName("FNLeaves2");
	public static Block newLeaves3 = new BlockNewLeaves(false, newFruit, 7, 2).setCreativeTab(tab).setBlockName("FNLeaves3");
	public static Block newLeaves4 = new BlockNewLeaves(false, newFruit, 7, 3).setCreativeTab(tab).setBlockName("FNLeaves4");
	public static Block newLeaves5 = new BlockNewLeaves(false, null, 7, 4).setCreativeTab(tab).setBlockName("FNLeaves5");
	public static Block newLeaves6 = new BlockNewLeaves(false, null, 1, 5).setCreativeTab(tab).setBlockName("FNLeaves6");
	...
	public static Block fNSapling1 = new BlockNewSap1().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setCreativeTab(tab);
	public static Block fNSapling2 = new BlockNewSap2().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setCreativeTab(tab);
	public static Block fNSapling3 = new BlockNewSap3().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setCreativeTab(tab);
    ...
    public static BlockWoodSlab newHalfPlanks1 = (BlockWoodSlab) new BlockNewHalfPlanks(false, 0).setHardness(2.0F).setResistance(5F).setStepSound(Block.soundTypeWood).setBlockName("halfPlank").setCreativeTab(tab);
	public static BlockWoodSlab newHalfPlanks2 = (BlockWoodSlab) new BlockNewHalfPlanks(false, 1).setHardness(2.0F).setResistance(5F).setStepSound(Block.soundTypeWood).setBlockName("halfPlank2").setCreativeTab(tab);
	public static BlockWoodSlab newDoubleHalfPlanks1 = (BlockWoodSlab) new BlockNewHalfPlanks(true, 0).setHardness(2.0F).setResistance(5F).setStepSound(Block.soundTypeWood).setBlockName("dHalfPlank");
	public static BlockWoodSlab newDoubleHalfPlanks2 = (BlockWoodSlab) new BlockNewHalfPlanks(true, 1).setHardness(2.0F).setResistance(5F).setStepSound(Block.soundTypeWood).setBlockName("dHalfPlank2");
    ...
    public static Block fNFlowers = new BlockNewFlowers().setHardness(0.0F).setStepSound(Block.soundTypeGrass).setCreativeTab(tab);
    public static Block newStairs1 = new BlockNewStairs(FNBlocks.newPlanks1, 0).setBlockName("FNWStairs1").setCreativeTab(tab);
    public static Block newStairs2 = new BlockNewStairs(FNBlocks.newPlanks1, 1).setBlockName("FNWStairs2").setCreativeTab(tab);
    public static Block newStairs3 = new BlockNewStairs(FNBlocks.newPlanks1, 2).setBlockName("FNWStairs3").setCreativeTab(tab);
    public static Block newStairs4 = new BlockNewStairs(FNBlocks.newPlanks1, 3).setBlockName("FNWStairs4").setCreativeTab(tab);
    public static Block newStairs5 = new BlockNewStairs(FNBlocks.newPlanks1, 4).setBlockName("FNWStairs5").setCreativeTab(tab);
    public static Block newStairs6 = new BlockNewStairs(FNBlocks.newPlanks1, 5).setBlockName("FNWStairs6").setCreativeTab(tab);
    public static Block newStairs7 = new BlockNewStairs(FNBlocks.newPlanks1, 6).setBlockName("FNWStairs7").setCreativeTab(tab);
    public static Block newStairs8 = new BlockNewStairs(FNBlocks.newPlanks1, 7).setBlockName("FNWStairs8").setCreativeTab(tab);
    //public static Block newStairs9; //acacia - removed as Mojang added acacia to vanilla
    public static Block newStairs10 = new BlockNewStairs(FNBlocks.newPlanks1, 9).setBlockName("FNWStairs10").setCreativeTab(tab);
    public static Block newStairs11 = new BlockNewStairs(FNBlocks.newPlanks1, 10).setBlockName("FNWStairs11").setCreativeTab(tab);
    public static Block newStairs12 = new BlockNewStairs(FNBlocks.newPlanks1, 11).setBlockName("FNWStairs12").setCreativeTab(tab);
    public static Block newStairs13 = new BlockNewStairs(FNBlocks.newPlanks1, 12).setBlockName("FNWStairs13").setCreativeTab(tab);
    public static Block newStairs14 = new BlockNewStairs(FNBlocks.crystalWood, 2).setBlockName("FNWStairs14").setLightLevel(0.8F).setCreativeTab(tab);
    public static Block newStairs15 = new BlockNewStairs(FNBlocks.crystalWood, 3).setBlockName("FNWStairs15").setLightLevel(0.8F).setCreativeTab(tab);
    ...
    public static Block newStoneStairs1 = new BlockNewStairs(newStones, 5).setBlockName("FNSStairs1").setCreativeTab(tab);
    public static Block newStoneStairs2 = new BlockNewStairs(newStones, 6).setBlockName("FNSStairs2").setCreativeTab(tab);
    public static Block newStoneStairs3 = new BlockNewStairs(newStones, 7).setBlockName("FNSStairs3").setCreativeTab(tab);
    public static Block newStoneStairs4 = new BlockNewStairs(newStones, 8).setBlockName("FNSStairs4").setCreativeTab(tab);
    public static Block newCrystalStairs1 = new BlockNewStairs(FNBlocks.crystalBlock, 2).setBlockName("FNCStairs1").setLightLevel(0.8F).setCreativeTab(tab);
    public static Block newCrystalStairs2 = new BlockNewStairs(FNBlocks.crystalBlock, 3).setBlockName("FNCStairs2").setLightLevel(0.8F).setCreativeTab(tab);
    public static BlockSlab newHalfStone = (BlockSlab) new BlockNewHalfStone(false).setBlockName("FNHalfStone").setCreativeTab(tab);
    ...
    public static Block camo = new BlockCamo(false).setBlockName("falseBlock").setCreativeTab(tab).setHardness(0.5F).setLightOpacity(100);
    public static Block oneWayCamo = new BlockCamo(true).setBlockName("oneWayCamo").setCreativeTab(tab).setHardness(0.5F);

    public static Block flowerPot = new BlockNewFlowerPot().setHardness(0.0F).setStepSound(Block.soundTypeStone).setBlockName("flowerPot").setCreativeTab(tab);
	public static Block rope = new BlockRope().setHardness(0.5F).setResistance(1F).setStepSound(Block.soundTypeGrass).setBlockName("rope");
	
	public static Fluid hydrogen = new Fluid("Hydrogen").setGaseous(true).setDensity(-1).setViscosity(1).setUnlocalizedName("H2");
	public static Fluid helium = new Fluid("Helium").setGaseous(true).setDensity(-1).setViscosity(1).setUnlocalizedName("He");
	public static Fluid steam = new Fluid("Steam").setGaseous(true).setDensity(-1).setViscosity(3000).setUnlocalizedName("H2Ov");
	public static Fluid methane = new Fluid("Methane").setGaseous(true).setDensity(-1).setViscosity(2).setUnlocalizedName("CH4");
	public static Fluid oxygen = new Fluid("Oxygen").setGaseous(true).setDensity(20).setViscosity(2000).setUnlocalizedName("O2");
	public static Fluid oil = new Fluid("Oil").setGaseous(true).setDensity(2000).setViscosity(3000).setUnlocalizedName("oil");
	...
	public static void regiserFluids() 
	{
		...
		FluidContainerRegistry.registerFluidContainer(oil, new ItemStack(FNItems.newBucketItems, 1, 1), new ItemStack(Items.bucket));
