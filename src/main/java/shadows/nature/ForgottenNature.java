...
import ForgottenNature.Blocks.BlockFluidLightGas;
import ForgottenNature.Proxy.*;
import ForgottenNature.WorldGen.RemoveBiomes;
	...
	public void preInit(FMLPreInitializationEvent event)
	  {
        ...
        try 
        {
			...
			if(bamSpreadBuffer < 1)
				bamSpreadBuffer = 1;
			//floating islands
			floatingIslands = cfg.get(Configuration.CATEGORY_GENERAL, "Generate Floating Islands", true).getBoolean(true);
			surfaceTeleporter = cfg.get(Configuration.CATEGORY_GENERAL, "Allow Surface Teleporter", true).getBoolean(true);
			//seed drop chance
	        ...
	        tropicalForestHill = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Tropical Forest Hills", true).getBoolean(true);
	        redwoodForestHill = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Redwood Forest Hills", true).getBoolean(true);
	        crystalForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Crystal Forest", true).getBoolean(true);
	        greatwoodForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Greatwood Forest", true).getBoolean(true);
	        mapleForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Maple Forest", true).getBoolean(true);
	        eucalyptusForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Eucalyptus Forest", true).getBoolean(true);
	        cherryBlossomWoodland = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Cherry Blossom Woodland", true).getBoolean(true);
	        crystalMushrooms = cfg.get(Configuration.CATEGORY_GENERAL, "Blocks: Crystal Mushrooms", true).getBoolean(true);
	        ...
	        vanBirchForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Vanilla Birch Forest", true).getBoolean(true);
	        vanRoofedForest = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Vanilla Roofed Forest", true).getBoolean(true);
	        ...
	        redwoodForestHillMax = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Redwood Forest Hill - Max Height", 10).getInt();
	        if(redwoodForestHillMax > 20)
	        	redwoodForestHillMax = 20;
	        redwoodForestHillMin = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Redwood Forest Hill - Min Height", 1).getInt();
	        if(redwoodForestHillMin < -10)
	        	redwoodForestHillMin = -10;
	        tropicalForestHillMax = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Tropical Forest Hill - Max Height", 10).getInt();
	        if(tropicalForestHillMax > 20)
	        	tropicalForestHillMax = 20;
	        tropicalForestHillMin = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Tropical Forest Hill - Min Height", 1).getInt();
	        if(tropicalForestHillMin < -10)
	        	tropicalForestHillMin = -10;
	        eucalyptusForestMax = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Eucalyptus Forest - Max Height", 3).getInt();
	        if(eucalyptusForestMax > 20)
	        	eucalyptusForestMax = 20;
	        eucalyptusForestMin = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Eucalyptus Forest - Min Height", 1).getInt();
	        if(eucalyptusForestMin < -10)
	        	eucalyptusForestMin = -10;
	        greatwoodForestMax = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Greatwood Forest - Max Height", 5).getInt();
	        if(greatwoodForestMax > 20)
	        	greatwoodForestMax = 20;
	        greatwoodForestMin = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Greatwood Forest - Min Height", 1).getInt();
	        ...
	        if(mapleForestMin < -10)
	        	mapleForestMin = -10;
	        Property cBWoodlandH = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Cherry Blossom Woodland - Max Height", 3);
	        ...
	        cherryBlossomWoodlandMin = cfg.get(Configuration.CATEGORY_GENERAL, "Biomes: Cherry Blossom Woodland - Min Height", 1).getInt();
