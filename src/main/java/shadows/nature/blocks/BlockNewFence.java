...
public class BlockNewFence extends BlockFence {
	...
	public void harvestBlock(World world, EntityPlayer entityplayer, int i, int j, int k, int l) {
		...
		if (l == 2) {
			dropBlockAsItem(world, i, j, k, new ItemStack(this, 1, 2)); // dark
																		// red
		}

		if (l == 3) {
			dropBlockAsItem(world, i, j, k, new ItemStack(this, 1, 3)); // dark
																		// yellow
		}
		...
		if (l == 12) {
			dropBlockAsItem(world, i, j, k, new ItemStack(this, 1, 12)); // dried
																			// bamboo
		}
