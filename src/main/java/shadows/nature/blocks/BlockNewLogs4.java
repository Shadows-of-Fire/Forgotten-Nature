...
public class BlockNewLogs4 extends Block
{
    ...
    {
    	return (i == 3 || i == 2) ? logIcons[0] : (j == 0 ? logIcons[1] : 
    		(j == 1 ? logIcons[2] : (j == 2 ? logIcons[3] : (j == 3 ? logIcons[4] : 
    		(j == 4 ? logIcons[5] : (j == 5 ? logIcons[6] : (j == 6 ? logIcons[7] : 
    		(j == 7 ? logIcons[8] : (j == 8 ? logIcons[9] : (j == 9 ? logIcons[10] : 
    		(j == 10 ? logIcons[11] : (j == 11 ? logIcons[12] : (j == 12 ? logIcons[13] : 
			(j == 13 ? logIcons[14] : (j == 14 ? logIcons[15] : logIcons[16])))))))))))))));
    }
