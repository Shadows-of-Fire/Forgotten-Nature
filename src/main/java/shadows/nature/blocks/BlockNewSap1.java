...
import shadows.nature.gen.genAngel;
import shadows.nature.gen.genCherry;
import shadows.nature.gen.genCypress;
import shadows.nature.gen.genDecBush;
import shadows.nature.gen.genDesertTree;
import shadows.nature.gen.genEucalyptus;
import shadows.nature.gen.genEverBush;
import shadows.nature.gen.genFig;
import shadows.nature.gen.genFruit;
import shadows.nature.gen.genJoshua;
import shadows.nature.gen.genSequoia;
import shadows.nature.gen.genWillow;
...
public class BlockNewSap1 extends BlockFlower {
	...
	public void growTree(World world, int i, int j, int k, Random random) {
		...
		if (l == 1) {
			...
			obj = new genCherry(FNBlocks.newLeaves1, 0, Block.getBlockById(17), 0); // red
																					// maple
		} else if (l == 3) {
			obj = new genAngel(FNBlocks.newLeaves1, 1); // angel oak
		} else if (l == 4) {
			obj = new genCherry(FNBlocks.newLeaves1, 2, Block.getBlockById(17), 0); // yellow
																					// maple
		} else if (l == 5) {
			...
			obj = new genDesertTree(FNBlocks.newLeaves1, 6, FNBlocks.newLogs1, 2); // Desert
																					// tree
		}
