...
import ForgottenNature.Proxy.FNClientProxy;
...
public class BlockNewLogs1 extends Block
{
    ...
    public IIcon getIcon(int i, int j)
    {
    	return (i == 1 || i == 0) && (j % 2 == 0) ? logIcons[0] : 
            ...
            ((j == 0 || j == 1) ? logIcons[1] : ((j == 2 || j == 3) ? logIcons[2] : 
            ((j == 4 || j == 5) ? logIcons[3] : ((j == 6 || j == 7) ? logIcons[4] : 
            ((j == 8 || j == 9) ? logIcons[5] : ((j == 10 || j == 11) ? logIcons[6] : 
            ((j == 12 || j == 13) ? logIcons[7] : logIcons[8]))))))));
    }
