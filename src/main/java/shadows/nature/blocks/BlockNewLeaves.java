...
//    		this.leaveIcons[10] = 
    ...
    public void onBlockClicked(World world, int i, int j, int k, EntityPlayer entityplayer)
    {
    	if(!world.isRemote)
    	{
	        ...
	        if(leafInd == 1 && met == 5) //if apple on leaf
	        {
	            ...
	            dropBlockAsItem(world, i, j, k, new ItemStack(Items.apple, 1, 0));//drop apple
	        }
	        else
	        if(leafInd == 4)
	        {
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
    	if (!world.isRemote)
        {
	        ...
	        if(leafInd == 1 && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(4) == 0)
	        {
        	...
        	if(leafInd == 2 && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(4) == 0)
        	{
        	...
        	if(leafInd == 3 && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(4) == 0)
        	{
        		int ffruit = 0;
	            if (world.isAirBlock(i, j - 1, k))
	            {
        	...
        	if(leafInd == 4 && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(6) == 0)
        	{
	            if (world.isAirBlock(i, j - 1, k))
	            {
        	...
        	if(leafInd == 5 && world.getBlockLightValue(i, j + 1, k) >= 9 && random.nextInt(4) == 0)
        	{
    ...
    public void dropBlockAsItemWithChance(World world, int i, int j, int k, int l, float f, int i1)
    {
		...
		if (leafInd == 0 && world.rand.nextInt(14) < 1)
        {
            if ((l & 7) == 0)
            {
                dropBlockAsItem(world, i, j, k, new ItemStack(FNBlocks.fNSapling1, 1, 2));    //red maple
            }
            if ((l & 7) == 1 && world.rand.nextInt(14) == 0)
            {
                dropBlockAsItem(world, i, j, k, new ItemStack(FNBlocks.fNSapling1, 1, 3));    //angel oak
            }
            if ((l & 7) == 2)
            {
                dropBlockAsItem(world, i, j, k, new ItemStack(FNBlocks.fNSapling1, 1, 4));    //yellow maple
            }
            if ((l & 7) == 3)
            {
            ...
            if ((l & 7) == 6)
            {
                dropBlockAsItem(world, i, j, k, new ItemStack(FNBlocks.fNSapling1, 1, 0));    //desert tree
            }
            if ((l & 7) == 7)
            {
		...
		if(leafInd == 1 && world.rand.nextInt(14) < 1)
		{
		...
		if (leafInd == 2 && world.rand.nextInt(7) < 1)
		{
		...
		if(leafInd == 3 && world.rand.nextInt(9) < 1)
		{
...
//            if ((l & 7) == 2)
//            {
//                dropBlockAsItem(world, i, j, k, new ItemStack(FNBlocks.fNSapling2, 1, 7));    //cocoa
//            }
		...
		if(leafInd == 4 && world.rand.nextInt(7) < 1)
		{
		...
		if(leafInd == 5 && world.rand.nextInt(7) < 1)
		{
			if ((l & 7) == 0 || (l & 7) == 1)
            {
