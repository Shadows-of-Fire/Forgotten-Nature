    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) 
    {
      ...
      //FN and vanilla biome instances
        if (biome.biomeID == 16)	//beach
        {
            ...
            {
                genPalm tree = new genPalm(FNBlocks.newLeaves3, 3, fNNewLogs1, 14); //palm tree
                k = i + random.nextInt(8) + 8;
                l = j + random.nextInt(8) + 8;
                il = world.getHeightValue(k, l);
            ...
            if (random.nextInt(16) == 0 && ForgottenNature.banana)
            {
                genPalm tree = new genPalm(FNBlocks.newLeaves4, 5, FNBlocks.newLogs3, 1); //banana tree
                k = i + random.nextInt(8) + 8;
                l = j + random.nextInt(8) + 8;
                il = world.getHeightValue(k, l);
                tree.generate(world, random, k, il, l);
        ...
        if (biome.biomeID == 2 || biome.biomeID == 17)//desert
        {
            ...
            if (random.nextInt(65) == 0 && ForgottenNature.Joshua) //joshua
            {
        ...
        if ((biome.biomeID == 1))//plains
        {
            ...
            if (random.nextInt(70) == 0 && ForgottenNature.Fig) //fig
            {
        ...
        if ((biome.biomeID == 4 || biome.biomeID == 18 || biome.biomeID == 27 || biome.biomeID == 28))//forests
        {
            ...
            if (random.nextInt(8) == 0 && ForgottenNature.decBush) //decbush
            {
        ...
        if ((biome.biomeID == 5 || biome.biomeID == 19 || biome.biomeID == 30 || biome.biomeID == 31 || biome.biomeID == 32 || biome.biomeID == 33))//taigas
        {
            ...
            if (random.nextInt(50) == 0 && ForgottenNature.YellowMaple) //yMaple
            {
            ...
            if (random.nextInt(130) == 0 && ForgottenNature.Sequoia) //sequoia
            {
            ...
            if (random.nextInt(9) == 0 && ForgottenNature.cedar) //cedar
            {
      ...
      //FN biomes
        ...
        if (biome.biomeID == (bID + 2) || biome.biomeID == (bID + 3))//redwood forest
        {
        	for(int iter = 0; iter <= ForgottenNature.newTreePerChunkCount; iter++)
        	{
        ...
        if (biome.biomeID == (bID + 5))//greatwood forest
        {
        	for(int iter = 0; iter <= ForgottenNature.newTreePerChunkCount; iter++)
        	{
            	if (random.nextInt(18) == 0 && ForgottenNature.AngelOak) //angel oak
                {
            		genAngel tree = new genAngel(fNNewLeaves1, 1);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
            	...
            	if (random.nextInt(18) == 0 && ForgottenNature.Fig) //fig tree
                {
            		genFig tree = new genFig(fNNewLeaves1, 4, 0, 2);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
            	...
            	else if (random.nextInt(8) == 0 && ForgottenNature.decBush) // deciduous bush
                {
            		genDecBush tree = new genDecBush(FNBlocks.newLeaves3, 1, 0);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
        ...
        if (biome.biomeID == (bID + 6))//maple forest
        {
        	for(int iter = 0; iter <= ForgottenNature.newTreePerChunkCount; iter++)
        	{
            	...
            	if (ForgottenNature.RedMaple) //rmaple
                {
            		genCherry tree = new genCherry(fNNewLeaves1, 0, vLog, 0);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
            	...
            	if (random.nextInt(8) == 0 && ForgottenNature.decBush) // deciduous bush
                {
            		genDecBush tree = new genDecBush(FNBlocks.newLeaves3, 1, 0);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
        ...
        if (biome.biomeID == (bID + 9))//eucalyptus forest
        {
        	for(int iter = 0; iter <= ForgottenNature.newTreePerChunkCount; iter++)
        	{
        		...
        		if(random.nextInt(2) == 0 && ForgottenNature.wTopEucalyptus)
        		{
        			genWTEucalyptus tree = new genWTEucalyptus(FNBlocks.newLeaves4, 3, FNBlocks.newLogs2, 14);
                    k = i + random.nextInt(12) + 6;
                    l = j + random.nextInt(12) + 6;
        ...
        if (biome.biomeID == bID || biome.biomeID == (bID + 1))//tropical forest
        {
        	for(int iter = 0; iter <= ForgottenNature.newTreePerChunkCount; iter++)
        	{
