...
{
	public static final String[] names1 = new String[] {"barite", "bertrandite", "erythrite", "molybdenite", "stibnite", 
			"monazite", "feldspar", "fluorite", "halite", "pentlandite", "petalite", "pyrite"};
