...
{
	Block blk;
	public static final String[] names1 = new String[] {"desertironwoodsapling", "cherrysappling", "redmaplesapling", "angeloaksapling", 
			"yellowmaplesapling", "jacarandasapling", "applesapling", "eucalyptussapling", "sequoiasapling", "figsapling", 
			"cypresssapling", "dummy", "joshuasapling", "swampwillowsapling", "deciduoubushling", "evergreenbushling"};
	public static final String[] names2 = new String[] {"palmsapling", "desertwillowsapling", "cedarsapling", "ginkgosapling", 
			"poplarsapling", "beechsapling", "walnutsapling", "dummy", "widtopeucalyptussapling", "bukkitsapling", "bananasapling", 
			"orangesapling", "peachsapling", "lemonsapling", "blueberrybushling", "raspberrysapling"};
