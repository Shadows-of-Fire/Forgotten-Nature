...
public class ItemNewAxe extends ItemTool
{
    ...
    public static final Set blocksEffectiveAgainst = Sets.newHashSet(new Block[] {
        	FNBlocks.newPlanks1, FNBlocks.newPlanks2, FNBlocks.newLogs1, FNBlocks.newLogs2, FNBlocks.newLogs3, FNBlocks.newLogs4, 
        	Blocks.planks, Blocks.bookshelf, Blocks.log, Blocks.log2, Blocks.chest, Blocks.wooden_slab, Blocks.pumpkin, 
        	Blocks.lit_pumpkin, FNBlocks.crystalWood});
