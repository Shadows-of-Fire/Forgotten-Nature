...
//    	"chestPlateTitanStone", "helmetTitanStone", "leggingsTitanStone", "bootsTitanStone"};
        ...
        public IIcon getIconFromDamage(int par1)
        {
        	...
        	if(this == FNItems.plateObsidian)
        		return this.armorIcons[1];
        	else
        	if(this == FNItems.legsObsidian)
        		return this.armorIcons[2];
        	else
        	if(this == FNItems.bootsObsidian)
        		return this.armorIcons[3];
        	else
        	if(this == FNItems.helmetTitanStone)
        		return this.armorIcons[4];
        	else
        	if(this == FNItems.plateTitanStone)
        		return this.armorIcons[5];
        	else
        	if(this == FNItems.legsTitanStone)
