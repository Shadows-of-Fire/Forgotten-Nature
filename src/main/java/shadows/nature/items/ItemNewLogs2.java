...
{
	Block log; 
	public static final String[] names = new String[] {"desertwillowlog", "*desertwillowlog", "cedarlog", 
			"*cedarlog", "ginkgolog", "*ginkgolog", "beechlog", "*beechlog", "walnutlog", 
			"*walnutlog", "dummy", "*dummy", "dummy2", "*dummy2", "widetopeucalyptus","*widetopeucalyptus"};
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else if (par3World.canPlaceEntityOnSide(this.log, par4, par5, par6, false, par7, par2EntityPlayer, par1ItemStack))
        {
            ...
            int var14 = this.log.onBlockPlaced(par3World, par4, par5, par6, par7, par8, par9, par10, var13);
            if (log == FNBlocks.newLogs4)
            {
            	met = var14 + 1;
            }
            else
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ, int metadata)
    {
       ...
       if (world.getBlock(x, y, z) == this.log)
       {
           this.log.onBlockPlacedBy(world, x, y, z, player, stack);
           this.log.onPostBlockPlaced(world, x, y, z, metadata);
       }
       return true;
    }
}