...
public class ItemOreMats extends Item
{
	public static final String[] names1 = new String[] {"aluminumIngot", "antimonyIngot", "bariumIngot", 
			...
			"galliumIngot", "leadIngot", "lithiumIngot", "manganeseIngot", "molybdenumIngot", "neodymiumIngot", "nickelIngot"};
	public static final String[] names2 = new String[] {"PGMIngots", "potassiumIngot", "pyritePowder", 
			"salt", "samariumIngot", "siliconIngot", "silverIngot", "sphaleriteIngot", "sulfurChunk", 
			"tantalumIngot", "thoriumIngot", "tinIngot", "titaniumIngot", "tungstenIngot", "uraniumIngot",
			"vanadiumIngot"};
