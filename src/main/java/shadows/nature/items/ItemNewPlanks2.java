...
{
	public static final String[] names = new String[] {"herringboneparquetplank", "xparquetplank", "frederiksborgparquetplank", 
			"fordonparquetplank", "latticeparquetplank", "diamondparquetplank", "pavimentiparquetplank"};
