...
public class ItemNewHalfPlanks extends ItemSlab {
	...
	public static final String[] woodType = new String[] { "brownWoodSlab", "purpleWoodSlab", "DarkRedWoodSlab",
			"DarkYellowWoodSlab", "PeachWoodSlab", "OrangeWoodSlab", "BrightwoodSlab", "RedwoodSlab" };
		...
		if (this.block == dSlab) {
			...
			if ((par7 == 1 && !var14 || par7 == 0 && var14) && block == this.block
				...
				if (par3World
						...
						&& par3World.setBlock(par4, par5, par6, FNBlocks.newDoubleHalfPlanks1, var13, 3)) {
	...
	private boolean funcCheck(ItemStack p_150946_1_, EntityPlayer p_150946_2_, World p_150946_3_, int p_150946_4_,
		...
		if (block == this.block && j1 == p_150946_1_.getItemDamage()) {
			if (p_150946_3_.checkNoEntityCollision(
					...
					&& p_150946_3_.setBlock(p_150946_4_, p_150946_5_, p_150946_6_, FNBlocks.newDoubleHalfPlanks1, j1,
							3)) {
