...
import shadows.ancient.blocks.BlockCamo;
import shadows.ancient.blocks.BlockCrystalBlock;
import shadows.ancient.blocks.BlockCrystalLeaves;
import shadows.ancient.blocks.BlockCrystalMushroom;
import shadows.ancient.blocks.BlockCrystalMushroomBlock;
import shadows.ancient.blocks.BlockCrystalStone;
import shadows.ancient.blocks.BlockCrystalWood;
import shadows.ancient.blocks.BlockFluidLightGas;
import shadows.ancient.blocks.BlockGrapeTomCabPine;
import shadows.ancient.blocks.BlockHempCotBamCorn;
import shadows.ancient.blocks.BlockKCelOniGar;
import shadows.ancient.blocks.BlockNetherLeaves;
import shadows.ancient.blocks.BlockNetherLogs;
import shadows.ancient.blocks.BlockNewFence;
import shadows.ancient.blocks.BlockNewFlowerPot;
import shadows.ancient.blocks.BlockNewFlowers;
import shadows.ancient.blocks.BlockNewFruit;
import shadows.ancient.blocks.BlockNewHalfPlanks;
import shadows.ancient.blocks.BlockNewHalfStone;
import shadows.ancient.blocks.BlockNewLeaves;
import shadows.ancient.blocks.BlockNewLogs1;
import shadows.ancient.blocks.BlockNewLogs2;
import shadows.ancient.blocks.BlockNewLogs3;
import shadows.ancient.blocks.BlockNewLogs4;
import shadows.ancient.blocks.BlockNewPlanks;
import shadows.ancient.blocks.BlockNewSap1;
import shadows.ancient.blocks.BlockNewSap2;
import shadows.ancient.blocks.BlockNewSap3;
import shadows.ancient.blocks.BlockNewStairs;
import shadows.ancient.blocks.BlockNewStone;
import shadows.ancient.blocks.BlockNewTorch;
import shadows.ancient.blocks.BlockOres;
import shadows.ancient.blocks.BlockParsWChestRiceBroc;
import shadows.ancient.blocks.BlockPeaTurnGinger;
import shadows.ancient.blocks.BlockRope;
import shadows.ancient.blocks.FNBlockGlass;
import shadows.ancient.events.BreakBlockHandler;
import shadows.ancient.items.ItemBamboo;
import shadows.ancient.items.ItemBlockCamo;
import shadows.ancient.items.ItemCrystalBlock;
import shadows.ancient.items.ItemCrystalLeaves;
import shadows.ancient.items.ItemCrystalStone;
import shadows.ancient.items.ItemCrystalWood;
import shadows.ancient.items.ItemFlowerPot;
import shadows.ancient.items.ItemNetherLeaves;
import shadows.ancient.items.ItemNetherLogs;
import shadows.ancient.items.ItemNewFence;
import shadows.ancient.items.ItemNewFlowers;
import shadows.ancient.items.ItemNewGlass;
import shadows.ancient.items.ItemNewHalfPlanks;
import shadows.ancient.items.ItemNewHalfPlanks2;
import shadows.ancient.items.ItemNewHalfStone;
import shadows.ancient.items.ItemNewLeaves;
import shadows.ancient.items.ItemNewLogs1;
import shadows.ancient.items.ItemNewLogs2;
import shadows.ancient.items.ItemNewLogs3;
import shadows.ancient.items.ItemNewLogs4;
import shadows.ancient.items.ItemNewPlanks1;
import shadows.ancient.items.ItemNewPlanks2;
import shadows.ancient.items.ItemNewSap;
import shadows.ancient.items.ItemNewStone;
import shadows.ancient.items.ItemOre;
import shadows.ancient.items.ItemTorch;
