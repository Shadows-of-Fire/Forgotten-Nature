...
public class BiomeGenCrystalForest extends BiomeGenBase {
	...
	// size = 8;
	// }
	// return (WorldGenerator)(random.nextInt(25) > 0 ? new
	// genCrystal(mod_ForgottenNature.crystalLeavesID, 1,
	// mod_ForgottenNature.crystalWoodID, 0, size) : //crystal
	// (random.nextInt(25) > 0 ? new
	// genCrystal(mod_ForgottenNature.crystalLeavesID, 0,
	// mod_ForgottenNature.crystalWoodID, 1, size) : //darkcrystal
