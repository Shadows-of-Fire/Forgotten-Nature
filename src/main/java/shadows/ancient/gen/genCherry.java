...
public class genCherry extends WorldGenerator {
	/**
	...
	public genCherry(Block i, int j, Block k, int l) {
		leaf = i;
		leafMeta = j;
		log = k;
		logMeta = l;
		if (leaf == FNBlocks.newLeaves2 && leafMeta == 1 && rand.nextInt(10) == 0)
			leafMeta = 2;
	}
		...
		for (var11[par5] = var10[par5]; var12 <= var7; ++var12) {
			...
			while (var13 <= var7) {
				...
				if (var15 > (double) (par4 * par4)) {
					...
					if (Block.getIdFromBlock(var14) != 0 && var14 != leaf) {
						++var13;
					} else {
						this.setBlockAndNotifyAdequately(this.worldObj, var11[0], var11[1], var11[2], leaf, leafMeta);
						++var13;
					}
				}
			}
	...
	void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
		...
		if (var4[var6] != 0) {
			...
			for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
				...
				this.setBlockAndNotifyAdequately(this.worldObj, var14[0], var14[1], var14[2], log, logMeta);
			}
		}
	}
	...
	int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger) {
		...
		if (var3[var5] == 0) {
			...
			for (var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
				...
				if (var16 != Block.getBlockById(0) && var16 != Block.getBlockById(18)) {
					break;
				}
			}
	...
	boolean validTreeLocation() {
		...
		int var3 = Block.getIdFromBlock(this.worldObj.getBlock(this.basePos[0], this.basePos[1] - 1, this.basePos[2]));
