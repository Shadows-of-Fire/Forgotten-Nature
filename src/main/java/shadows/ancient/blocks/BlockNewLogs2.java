...
public class BlockNewLogs2 extends Block {
	...
	public IIcon getIcon(int i, int j) {
		return (i == 1 || i == 0) && (j % 2 == 0) ? logIcons[0] : ((i == 5 || i == 4) && (j % 2 == 1) ? logIcons[0] : ((j == 0 || j == 1) ? logIcons[1] : ((j == 2 || j == 3) ? logIcons[2] : ((j == 4 || j == 5) ? logIcons[3] : ((j == 6 || j == 7) ? logIcons[4] : ((j == 8 || j == 9) ? logIcons[5] : logIcons[8]))))));
	}
