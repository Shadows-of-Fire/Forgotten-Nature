...
public class BlockNewLogs1 extends Block {
	@SideOnly(Side.CLIENT)
	private IIcon[] logIcons;
	private static int renderId;

	public BlockNewLogs1() {
		super(Material.wood);
		setHardness(2.0F);
		setStepSound(Block.soundTypeWood);
		setBlockName("FNLogs1");
	}

	@SideOnly(Side.CLIENT)
	public IIcon getIcon(int i, int j) {
		return (i == 1 || i == 0) && (j % 2 == 0) ? logIcons[0] : ((i == 5 || i == 4) && (j % 2 == 1) ? logIcons[0] : ((j == 0 || j == 1) ? logIcons[1] : ((j == 2 || j == 3) ? logIcons[2] : ((j == 4 || j == 5) ? logIcons[3] : ((j == 6 || j == 7) ? logIcons[4] : ((j == 8 || j == 9) ? logIcons[5] : ((j == 10 || j == 11) ? logIcons[6] : ((j == 12 || j == 13) ? logIcons[7] : logIcons[8]))))))));
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		...
		this.logIcons[2] = par1IconRegister.registerIcon("ForgottenNature:LogIronwood");
		this.logIcons[3] = par1IconRegister.registerIcon("ForgottenNature:LogEucalyptus");
		this.logIcons[4] = par1IconRegister.registerIcon("ForgottenNature:LogSequoia");
		// this.logIcons[5] =
		this.logIcons[6] = par1IconRegister.registerIcon("ForgottenNature:LogJoshua");
		this.logIcons[7] = par1IconRegister.registerIcon("ForgottenNature:LogSwampWillow");
		this.logIcons[8] = par1IconRegister.registerIcon("ForgottenNature:LogPalm");
	}
