...
public class ItemSaw extends ItemTool {
	...
	public static final Set blocksEffectiveAgainst = Sets
			.newHashSet(new Block[] { FNBlocks.newPlanks1, FNBlocks.newLogs1, FNBlocks.newLogs2, FNBlocks.newLogs3,
					Blocks.planks, Blocks.bookshelf, Blocks.log, Blocks.log2, Blocks.chest, Blocks.double_wooden_slab,
					Blocks.wooden_slab, Blocks.pumpkin, Blocks.lit_pumpkin, FNBlocks.crystalWood });
