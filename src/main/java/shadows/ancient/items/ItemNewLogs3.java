...
public class ItemNewLogs3 extends ItemBlock {
	public static final String[] names = new String[] { "bukkitlog", "bananalog", "orangelog", "peachlog", "lemonlog",
			"*bukkitlog", "*bananalog", "*orangelog", "*peachlog", "*lemonlog", "bukkitlog*", "bananalog*", "oranglog*",
			"peachlog*", "lemonlog*" };
