...
public class ItemTitanStonePA extends ItemTool {
	...
	private static Set blocksEffectiveAgainst = Sets.newHashSet(new Block[] { FNBlocks.newPlanks1, FNBlocks.newLogs1, FNBlocks.newLogs2, FNBlocks.newLogs3, Blocks.planks, Blocks.bookshelf, Blocks.log, Blocks.log2, Blocks.chest, Blocks.wooden_slab, Blocks.double_wooden_slab, Blocks.pumpkin, Blocks.lit_pumpkin, FNBlocks.crystalWood, Blocks.grass, Blocks.dirt, Blocks.sand, Blocks.gravel, Blocks.snow, Blocks.snow_layer, Blocks.clay, Blocks.farmland, Blocks.soul_sand, Blocks.mycelium, Blocks.cobblestone, Blocks.double_stone_slab, Blocks.stone_slab, Blocks.stone, Blocks.sandstone, Blocks.mossy_cobblestone, Blocks.iron_ore, Blocks.iron_block, Blocks.coal_ore, Blocks.gold_block, Blocks.gold_ore, Blocks.diamond_ore, Blocks.diamond_block, Blocks.ice, Blocks.lapis_ore, Blocks.lapis_block, Blocks.obsidian, FNBlocks.crystalStone });
	...
	public float func_150893_a(ItemStack par1ItemStack, Block par2Block) {
		return par2Block != null && (par2Block.getMaterial() == Material.iron || par2Block.getMaterial() == Material.rock || par2Block.getMaterial() == Material.wood) ? this.efficiencyOnProperMaterial : 1.0F;
	}
					...
					for (int i = -1; i <= 1; i++) {
						for (int j = 0; j <= 2; j++) {
							for (int k = -1; k <= 1; k++) {
								...
								if (blk != Blocks.bedrock && blk != Blocks.water && blk != Blocks.flowing_water && blk != Blocks.lava && blk != Blocks.flowing_lava) {
